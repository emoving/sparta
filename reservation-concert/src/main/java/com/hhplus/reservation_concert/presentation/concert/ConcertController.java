...
public class ConcertController {
    ...
    @GetMapping
    public ResponseEntity<ConcertsResponse> getConcerts(@RequestHeader(name = "X-Token") String xToken) {
        tokenFacade.validate(xToken);
    ...
    public ResponseEntity<PerformancesResponse> getPerformances(@RequestHeader(name = "X-Token") String xToken, @PathVariable Long concertId) {
        tokenFacade.validate(xToken);
    ...
    public ResponseEntity<SeatsResponse> getSeats(@RequestHeader(name = "X-Token") String xToken, @PathVariable Long performanceId) {
        tokenFacade.validate(xToken);
