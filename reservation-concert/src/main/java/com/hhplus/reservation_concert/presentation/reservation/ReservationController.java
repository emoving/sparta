...
public class ReservationController {
    ...
    @PostMapping
    public ResponseEntity<ReservationResponse> reserveSeat(HttpServletRequest request, @RequestBody ReservationRequest reservationRequest) {
    ...
    public ResponseEntity<PaymentResponse> pay(HttpServletRequest request, @PathVariable Long reservationId) {
        Token token = (Token) request.getAttribute("token");
